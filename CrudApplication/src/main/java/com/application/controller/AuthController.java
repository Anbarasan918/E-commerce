...
public class AuthController {
	...
	@PostMapping("/login")
    public Map<String, Object> loginHandler(@RequestBody UserData body){
        try {
        	HashMap<String, Object> map = new HashMap<>();
            UsernamePasswordAuthenticationToken authInputToken =
                    new UsernamePasswordAuthenticationToken(body.getEmailId(), body.getPassword());

            authManager.authenticate(authInputToken);

            String token = jwtUtil.generateToken(body.getEmailId());
